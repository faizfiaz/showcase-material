...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public void setTarget(Target target) {
        ...
        if (mTarget != null) {
            ...
            int midXPoint = width / 2;
            int yPos = targetPoint.y;
            int xPos = targetPoint.x;
            int leftPos = targetBounds.left;
            int rightPos = targetBounds.right;

            int topPosShape = targetBounds.top;
            ...
            //Add this line to check want to show in top or bottom / left or right
            if (topBottom) {
                if (yPos > midPoint) {
                ...
                if (xPos > midXPoint) {
                    mContentTopMargin = topPosShape;
                    mContentLeftMargin = 0;
                    mContentRightMargin = (width - xPos) + radius + mShapePadding;
                    mGravity = Gravity.START | Gravity.RIGHT;
                } else {
                    mContentTopMargin = topPosShape;
                    mContentLeftMargin = xPos + radius + mShapePadding;
                    mContentRightMargin = 0;
                    mGravity = Gravity.END | Gravity.LEFT;
    ...
    public static class Builder {
        ...
        public Builder setTopBottom(boolean condition) {
            showcaseView.setTopBottom(condition);
            return this;
        }
